...
def generate_launch_description():
    ...
    print('world =', world)
    world_file_name = 'gazebo_ros_ackermann_drive_demo.world'
    world = os.path.join(get_package_share_directory('gazebo_plugins'),
    ...
    gazebo_run = ExecuteProcess(
        cmd=['gazebo', '-s', 'libgazebo_ros_factory.so', '-s', 'libgazebo_ros_ackermann_drive.so', world],
        output='screen')
